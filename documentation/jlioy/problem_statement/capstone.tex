...
\begin{titlepage}
    ...
    \begin{singlespace}
        ...
        % 6. Fill in your abstract    
        	This document covers the basic information of the \CapstoneProjectName{} project, It includes a project abstract, a definition and description of the problem we are trying to solve, our proposed solution, and performance metrics for the project.
        \end{abstract}     
    \end{singlespace}
\end{titlepage}
\newpage
